...
- **Hardware:** Shelly 1 Mini Gen4 hardware revision (printed on the PCB), and the firmware version you're running
...
- {model}: shelly-1-mini-gen4, shelly-1pm-mini-gen4, etc.
